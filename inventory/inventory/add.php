...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO sneaker (name, stock, price, prod_img) VALUES ('$name', '$stock', '$price', '$image_data')";
...
<body>
    <div class="container my-5">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-primary" name="submit" style="border:1px gray solid; padding: 5px; padding-left:9px; padding-right: 9px; border-radius:10px;">Submit</button>
        </form>
    </div>
